<template>
	...
	<div class="contents contents--full">
		<div class="contents__wrap">
			...
			<!--페이지 상단-->
			<div class="sub-top">
				<h3 v-if ="checkUserId.privilege == 'sAdmin'">공지 관리</h3>
				<h3 v-if ="checkUserId.privilege != 'sAdmin'">기관 공지</h3>
				<div class="sub-top__navi">
					<span class="icon-home navi--home"></span>
					<span v-if ="checkUserId.privilege == 'sAdmin'">공지 관리</span>
					<span v-if ="checkUserId.privilege != 'sAdmin'">기관 공지</span>
				</div>
			</div>
